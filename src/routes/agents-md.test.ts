...
function makeConfig(overrides: Partial<Config> = {}): Config {
  return {
    ...
    features: {
      ...
      link_tag: true, llms_txt: true, robots_txt: true, agents_md: true, api_catalog: true, fallback_widget: true,
    },
    ...
    agents_md: { path: "/.well-known/agents.md", mode: "merge", aliases: ["/AGENTS.md", "/agents.md"] }, api_catalog: { path: "/.well-known/api-catalog", mode: "merge" },
    ...
    cache: {
      ...
      agents_md_redirect_max_age: 86400, agents_md_redirect_s_maxage: 604800, api_catalog_max_age: 300, api_catalog_s_maxage: 21600, api_catalog_swr: 86400, api_catalog_sie: 86400,
